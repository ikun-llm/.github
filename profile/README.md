...
| [**ikun-call**](https://github.com/ikun-llm/ikun-call) | 语音通话 | **📞 给坤坤打电话 [🤗 在线体验](https://huggingface.co/spaces/IKUN-LLM/ikun-call)** |
...
- [x] 12 个学习仓库 — 完整 LLM 学习路线
- [x] ikun-call — 实时语音对话应用（豆包风格 UI）
- [ ] ikun-5B — 练习时长五年（规划中）
- [ ] 各仓库补充完整教程 + 训练好的模型权重
...
| 语音通话 | [ikun-call](https://huggingface.co/spaces/IKUN-LLM/ikun-call) | 📞 实时语音通话 — 给坤坤打电话 |
